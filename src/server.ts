...
app.post('/api/invoicecompliance', async (req, res) => {
  try {
    console.log('invoice compliance body:', req.body.req.body.sign_invpoice);
    ...
    const complience_response = await egs.checkInvoiceCompliance(sign_invpoice_p, invoice_hash)
